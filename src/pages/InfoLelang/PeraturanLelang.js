...
import Logo3 from '../../assets/image/home/aset-26.png';
import Logo4 from '../../assets/image/home/aset-22.png';
import Logo5 from '../../assets/image/home/aset-27.png';
import Logo6 from '../../assets/image/home/aset-28.png';
import Logo7 from '../../assets/image/home/aset-29.png';
import Logo8 from '../../assets/image/home/aset-30.png';
...
const arr = [
  {
    ...
    content: () => (
      ...
      didownload melalui situs web resmi LEGOAS maupun media distribusi aplikasi/software resmi yang 
      ditunjuk dan digunakan LEGOAS yang dimiliki oleh mobile operating system yang terdapat di handphone 
      pelanggan untuk melakukan proses pendaftaran, pembelian token, hingga pelaksanaan lelang.
      </p>
      <p>
      1.2) Situs web LEGOAS adalah layanan yang dapat diakses secara langsung oleh Peserta melalui telepon 
      selular (handphone atau tablet) dengan alamat www.legoas.co.id.
      </p>
      <p>
      1.3) Peserta Lelang adalah personal yang telah mendaftar melalui aplikasi dan website LEGOAS sesuai 
      dengan persyaratan dan kewajiban yang telah ditentukan. Sesuai Syarat dan Ketentuan, Peserta Lelang 
      akan mendapatkan 1 (satu) akun yang terdaftar dalam situs dan aplikasi mobile LEGOAS 
      (“Akun Peserta Lelang”). Untuk mengikuti lelang maka peserta lelang harus melakukan kewajibannya 
      dalam memilih paket keanggotaan yang diingini. Dengan pendaftaran tersebut dan melewati tahap 
      pemilihan paket keanggotaan maka Peserta Lelang dapat mengikuti proses lelang melalui aplikasi dan 
      website Legoas.
      </p>
      <p>
      1.4) Situs web LEGOAS adalah layanan yang dapat diakses secara langsung oleh Peserta melalui 
      telepon selular (handphone atau tablet) dengan alamat www.legoas.co.id.
      </p>
      <p>
      1.5) Token adalah hak peserta lelang berupa deposito sebagai jaminan keikutsertaan peserta lelang 
      dan dapat dikembalikan (refund) jika tidak menang atau kewajiban sebagai pemenang telah dipenuhi. 
      Token pada umumnya disebut dengan Nomor Peserta Lelang pada pelaksanaan lelang secara umum. 
      1 Token hanya untuk memenangkan 1 unit kendaraan.
      </p>
      <p>
      1.6) Biaya administrasi adalah kewajiban dari peserta lelang yang harus dipenuhi hanya kepada 
      peserta lelang memenangkan unit/produk yang diingini. Besaran uang administrasi sebesar 
      Rp. 1.500.000 per unit kendaraan mobil atau disesuaikan dengan masa-masa jika promosi. Biaya 
      administrasi selalu diinformasikan pada lelang yang akan dipilih.
      </p>
      <p>
      1.7) Penawaran LEGOAS adalah semua pengajuan harga pada penjualan melalui lelang secara onsite 
      dan atau online yang dilakukan oleh LEGOAS melalui aplikasi mobile dan situs web LEGOAS.
      </p>
      <p>
      1.8) Pemenang Lelang adalah peserta lelang yang telah mengajukan harga tertinggi atas produk/barang 
      yang dilelang hingga masa lelang atas Lot tersebut berakhir.
      </p>
      <p>
      1.9) Lelang LEGOAS adalah seluruh proses dan pelaksanaan lelang yang dilakukan oleh LEGOAS 
      penyelenggara lelang melalui aplikasi mobile dan situs web LEGOAS secara terbuka, telah melalui 
      persyaratan penyelenggaraan lelang di Indonesia.
      </p>
      <p>
      1.10) GRADE kendaraan adalah sertifikasi yang dilakukan oleh tim LEGOAS atas unit yang dilelang 
      untuk menunjukkan kondisi kendaraan secara keseluruhan dan dinilai atas body, interior, surat, 
      kondisi global mesin dan bagian bawah kendaraan.
      </p>
      <p>
      1.11) Situs web LEGOAS adalah layanan yang dapat diakses secara langsung oleh Peserta melalui 
      telepon selular (handphone atau tablet) dengan alamat www.legoas.co.id.
      </p>
      <p>
      1.12) Penitip Lelang adalah pemilik barang yang sah dan telah setuju untuk menitipkan assetnya untuk 
      dilelang melalui LEGOAS sesuai dengan kesepakatan yang telah disetujui keduabelah pihak menyangkut hak 
      dan kewajiban.
      </p></React.Fragment>
    )
  },
  {
    ...
    content: () => (
      <React.Fragment><p>
        2.1) Pengguna dan atau Peserta Lelang menyetujui seluruh kegiatan transaksi dilakukan dalam Lelang LEGOAS 
        melalui mobile aplikasi dan situs web LEGOAS dan tidak diperbolehkan melanggar peraturan 
        perundang-undangan yang berlaku di Indonesia. Atas pelanggaran yang dilakukan maka Peserta Lelang akan 
        dikenakan sanksi sesuai peraturan perundang-undangan dan tidak diperkenankan mengikuti lelang 
        selanjutnya.
      </p>
      <p>
      2.2) Pengguna dan Peserta Lelang tunduk dan taat pada semua peraturan yang berlaku di Indonesia yang berhubungan 
      dengan penggunaan jaringan dan komunikasi data, baik di wilayah Negara Kesatuan Republik Indonesia 
      maupun dari dan keluar wilayah Negara Kesatuan Republik Indonesia.
      </p>
      <p>
      ...
      <p>
      2.7) Konten yang ditampilkan melalui layanan Penawaran LEGOAS memungkinkan berisi ketidakakuratan dan 
      kesalahan ketik dan LEGOAS tidak menjamin keakuratan atau kelengkapan konten atau bahwa setiap cacat 
      akan diperbaiki. Ketergantungan pada konten, saran, pernyataan, atau informasi lainnya adalah berupa 
      risiko Peserta Lelang sendiri. LEGOAS berhak, atas kebijakan LEGOAS sendiri, untuk memperbaiki 
      kesalahan atau kelalaian di bagian layanan Penawaran LEGOAS mana pun dan untuk membuat perubahan pada 
      fitur, fungsi, atau konten layanan Penawaran LEGOAS kapan saja.
      </p>
      <p>
      2.8) LEGOAS tidak bertanggung jawab atas kegagalan atau penundaan dalam pelaksanaan penawaran atau kesalahan 
      yang terdapat dalam penawaran yang dilakukan melalui layanan Penawaran LEGOAS.
      </p>
      <p>
      2.9) LEGOAS menyediakan layanan Penawaran LEGOAS "apa adanya" dan tanpa jaminan atau kondisi apapun, 
      tersurat, tersirat maupun pernyataan. Tanpa membatasi, LEGOAS tidak bertanggung jawab atas kegagalan, 
      penundaan, atau kesalahan yang disebabkan oleh gangguan terhadap ketersediaan layanan atau layanan web 
      LEGOAS atau kesalahan atau kesalahan dalam konten atau fungsionalitasnya, perangkat lunak apapun dan / 
      atau kerusakan hardware (Peserta Lelang atau LEGOAS) dan / atau masalah koneksi internet (Peserta Lelang 
      atau LEGOAS), dan LEGOAS tidak menyatakan atau menjamin bahwa layanan Penawaran LEGOAS atau situs web 
      akan bebas error, bebas dari virus atau komponen berbahaya lainnya, atau bahwa setiap defeksi akan 
      diperbaiki.
      </p>
      </React.Fragment>
    )
  },
  {
    ...
    content: () => (
      <React.Fragment><p>
       ...
       <p>
       3.3) Peserta Lelang wajib merahasiakan kerahasiaan Akun Peserta Lelang beserta data yang tercantum didalamnya dan tidak boleh mengizinkan pihak ketiga untuk menggunakan atau mengakses Akun Peserta Lelang atau sebaliknya.
       </p>
       <p>
       3.4) Setiap tindakan, transaksi dan Penawaran LEGOAS yang dilakukan Peserta Lelang melalui situs dan aplikasi mobile LEGOAS bersifat final dan mengikat seketika.
       </p>
       <p>
       3.5) Hasil Penawaran LEGOAS akan ditampilkan di layar Peserta Lelang selama pelaksanaan Lelang LEGOAS berlangsung sesuai jenis dan nomor lot lelang yang diikuti.
       </p>
       <p>
       3.6) LEGOAS berhak menolak pendaftaran untuk mengajukan Penawaran LEGOAS, menarik izin bagi Peserta Lelang untuk menggunakan Penawaran LEGOAS, atau menghentikan Akun Peserta Lelang, dengan alasan apapun kapanpun, selama atau setelah Penjualan.
       </p>
       <p>
       3.7) Peserta Lelang bertanggung jawab penuh atas semua tawaran yang diajukan melalui Akun Peserta Lelang termasuk kewajiban untuk membayar secara penuh beserta biaya administrasinya dan tepat waktu sesuai dengan Ketentuan Pembayaran untuk setiap jenis Lelang LEGOAS dari Penawaran LEGOAS yang sukses diajukan dari Akun Peserta lelang.
       </p>
       <p>
       3.8) Peserta Lelang melakukan Penawaran LEGOAS secara sadar tanpa paksaan dari pihak mana pun dan Penawaran LEGOAS tersebut bersifat mengikat dan sah.
       </p>
       <p>
  ...
  },
  {
    key: '7',
    img: Logo7,
    title: 'Perubahan terhadap Syarat dan Ketentuan LEGOAS',
    content: () => (
      <p>
      LEGOAS berhak membuat perubahan pada syarat dan ketentuan ini sewaktu-waktu. Setiap perubahan akan 
      diposting di situs LEGOAS di www.legoas.co.id dan akan dilengkapi dengan pemberitahuan dan tautan ke 
      persyaratan yang direvisi di situs web LEGOAS. Peserta Lelalang diwajibkan selalu meninjau syarat dan 
      ketentuan ini secara teratur untuk memastikan Peserta Lelang mengetahui adanya perubahan yang dilakukan 
      oleh LEGOAS. Jika Peserta Lelang menggunakan Penawaran LEGOAS setelah perubahan telah dilakukan dan 
      diposting, Peserta Lelang akan dianggap telah menyetujui perubahan tersebut. Jika Peserta Lelang tidak 
      menyetujui perubahan tersebut, sebaiknya Peserta Lelang tidak menggunakan LEGOAS untuk berikutnya.
      </p>
    )
  },
  {
    ...
    content: () => (
      <React.Fragment><p>
      Dalam hal LEGOAS tidak dapat melakukan proses dan pelaksanaan lelang baik sebagian maupun seluruhnya 
      karena kejadian-kejadian atau hal-hal diluar kekuasaan maupun kemampuan LEGOAS, termasuk namun tidak 
      terbatas pada bencana alam, perang, huru-hara, peralatan/system/transmisi dalam keadaan tidak 
      berfungsi, terjadinya gangguan listrik, gangguan telekomunikasi, adanya kebijakan pemerintah yang 
      melarang LEGOAS memberikan layanan, serta kejadian-kejadian atau hal-hal lain di luar kekuasaan atau 
      kemampuan LEGOAS, maka Peserta Lelang dengan ini membebaskan LEGOAS dari segala macam tuntutan apa pun 
      dan dalam bentuk apapun terkait dengan hal tersebut.
      </p>
      <p>
      Ketentuan LEGOAS ini telah disesuaikan dengan ketentuan peraturan perundang-undangan ketentuan 
      Peraturan Menteri Keuangan nomor 90/PMK.06/2016 tentang Pedoman Pelaksanaan Lelang dengan Penawaran 
      Secara Tertulis Tanpa Kehadiran Peserta Lelang Melalui Sistem jo PMK Nomor 27/PMK.06/2016 tentang 
      Petunjuk Pelaksanaan Lelang dan berlaku untuk semua penawaran onsite/online pada penjualan melalui 
      lelang yang dilakukan oleh LEGOAS melalui aplikasi mobile dan situs web LEGOAS.
      </p>
      </React.Fragment>
    )
  }

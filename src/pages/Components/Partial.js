          ...
          >
            ...
            <Navbar.Collapse>
              <Nav pullRight>
                ...
                <NavItem eventKey={2} href="/info-lelang">
                  Info Lelang
                </NavItem>
                ...
                {/* <NavDropdown eventKey={3} title="Info Lelang" id="basic-nav-dropdown">
                  ...
                  <MenuItem eventKey={3.2} href="/tatacara-lelang">
                    Tata Cara Lelang
                  </MenuItem>
                  <MenuItem eventKey={3.3} href="/peraturan-lelang">
                    Peraturan Lelang
                  </MenuItem>
                </NavDropdown> */}
                ...
                <NavItem
                  eventKey={7}
                  href="https://lelang.legoas.co.id/Account/Login"
                  target="_blank"
                >
                  Login
                </NavItem>
                <NavItem
                  eventKey={8}
                  href="https://lelang.legoas.co.id/Auction/Bidder/Register"
                  target="_blank"
                >
                  Register
                </NavItem>
        ...
        <Grid>
          <Row>
            ...
            <Col xs={12} md={3}>
              ...
              />
              <p /> {/* space between input type and button social */}
